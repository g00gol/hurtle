export default function Nav() {
	return (
		<div className="min-w-full flex-grow-0 text-white bg-black flex justify-between items-center uppercase font-bold border-0 border-gray border-b">
			...
			<h1 className="text-4xl my-2">Hurtle</h1>
			<button className="px-4">
				<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
